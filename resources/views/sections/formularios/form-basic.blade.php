	...
	<form @if(Auth::getUser()->role_id == 2 || Auth::getUser()->role_id == 1) action="create-slider" @else action="profile/create-slider" @endif method="POST" enctype="multipart/form-data">
		...
		<div class="form-group py-3 dashborad-box" style="overflow: hidden;">
	    	...
	    	<div class="input-group">
	            <div class="mx-3">
	            	<input type="file" name="principal_img"  id="basic" max="2">
    		...
    		<div class="row">
    			<div class="uploader__box js-uploader__box l-center-box">
	                <div class="uploader__contents">
	                    <label class="button button--secondary" for="fileinput">Seleccionar</label>
	  	...
	  	<div class="form-group dashborad-box py-3">
	    	...
	    	<div class="input-group mb-2 mr-sm-2">
				<input 	type="text"
				    ...
				    data-language="en"
				    class="datepicker-here form-control" id="fecha-anuncios-basicos" name="fecha" required  placeholder="Selecciona el rango de fecha en la que será visible tú anuncio"/>
