			...
			@foreach($inactive_publicities as $slider)
				<tr>
					...
					<td scope="row">
						...
						<a href="{{ url('profile/administracion/eliminar-publicidad/') }}/{{$slider->id}}" style="cursor: pointer;" data-toggle="modal" data-target="#pubinactivas"  title="Eliminar anuncio"><i class="fas fa-trash-alt"></i></a>
					</td>
				</tr>
				<!-- Modal -->
				<div class="modal fade" id="pubinactivas" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
