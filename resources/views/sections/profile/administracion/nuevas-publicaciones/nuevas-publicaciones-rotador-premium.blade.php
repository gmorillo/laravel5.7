			...
			@foreach($new_premium_slideshow as $slider)
				<tr>
					...
					<td scope="row">
						...
						<a href="{{ url('profile/administracion/eliminar-publicidad/') }}/{{$slider->id}}" style="cursor: pointer;" data-toggle="modal" data-target="#exampleModal"  title="Eliminar anuncio"><i class="fas fa-trash-alt"></i></a>
					</td>
				</tr>
