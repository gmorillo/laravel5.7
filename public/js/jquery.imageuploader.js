    ...
    $.fn.uploader = function (options, testMode) {
        return this.each(function (index) {
            options = $.extend({
                ...
                instructionsCopy: 'AGREGA HASTA 5 IMÁGENES MÁS!!!',
            ...
            var dom = {
                ...
                selectButton: $('<input name="secondary_img[]" style="height: 0; width: 0;" id="fileinput' + index + '" type="file" multiple class="js-uploader__file-input uploader__file-input">' +
                    '<label for="fileinput' + index + '" style="cursor: pointer;" class="btn btn-outline-danger">' +
                ...
                secondarySelectButton: $('<input name="secondary_img[]" style="height: 0; width: 0;" id="secondaryfileinput' + index + '" type="file"' +
                    ...
                    '<label for="secondaryfileinput' + index + '" style="cursor: pointer;" class="btn btn-outline-danger">' +
